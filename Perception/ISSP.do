...
recode US_DEGR (1/2=1) (3/4=2) (5=3), gen(edu)
...
gen loginc=log(US_INC)

// Multinomial logit

drop if US_PRTY==95

mlogit V54 female AGE i.edu loginc i.US_PRTY, base(1)

//mlogit V54 i.age female i.edu loginc married i.URBRURAL, base(2)
